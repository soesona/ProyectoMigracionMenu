namespace ProyectoMigracionMenu
{
    partial class Login
    {
        ...
        private void InitializeComponent()
        {
            ...
            // LinkContra
            // 
            LinkContra.ActiveLinkColor = Color.FromArgb(85, 187, 190);
            LinkContra.AutoSize = true;
            LinkContra.Font = new Font("Century Gothic", 9.75F, FontStyle.Regular, GraphicsUnit.Point, 0);
            LinkContra.ForeColor = SystemColors.ActiveCaptionText;
            LinkContra.LinkColor = Color.DarkGray;
            LinkContra.Location = new Point(594, 451);
            LinkContra.Margin = new Padding(4, 0, 4, 0);
            LinkContra.Name = "LinkContra";
            LinkContra.Size = new Size(190, 21);
            LinkContra.TabIndex = 5;
            LinkContra.TabStop = true;
            LinkContra.Text = "Contraseña olvidada";
